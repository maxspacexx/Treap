...
/**
 * A treap is a form of key-val tree map which relies on randomly generated
...
public interface Treap<K extends Comparable<K>, V> extends Iterable<K> {
    ...
    /**
     * Retrieves the val associated with a key in this dictionary.
     * If the key is null or the key is not present in this
     * dictionary, this method returns null.
     *
     * @param key   the key whose associated val
     *              should be retrieved
     * @return      the val associated with the key, or
    ...
    /**
     * Adds a key-val pair to this dictionary.  Any old val
     * associated with the key is lost.  If the key or the val is
     * null, the pair is not added to the dictionary.
     *
     * @param key      the key to add to this dictionary
     * @param value    the val to associate with the key
     */
     ...
     * val associated with the removed key, or null if the key
     * is not present.
     *
     ...
     * of key and val using the object's toString(). Treaps should
